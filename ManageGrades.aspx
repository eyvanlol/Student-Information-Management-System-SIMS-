    ...
    <form id="form1" runat="server">
        <div class="sidebar">
            ...
            <nav class="mt-3">
                ...
                <div class="nav-item"><a href="ManageGrades.aspx" class="nav-link active"><i class="fas fa-edit"></i><span>Grades & Assessments</span></a></div>
                <div class="nav-item"><a href="#" class="nav-link"><i class="fas fa-chart-line"></i><span>Student Progress</span></a></div>
                <div class="nav-item"><a href="#" class="nav-link"><i class="fas fa-exclamation-triangle"></i><span>At-Risk Students</span></a></div>
                <div class="nav-item"><a href="#" class="nav-link"><i class="fas fa-folder-open"></i><span>Course Materials</span></a></div>
                <div class="nav-item"><a href="#" class="nav-link"><i class="fas fa-bullhorn"></i><span>Announcements</span></a></div>
