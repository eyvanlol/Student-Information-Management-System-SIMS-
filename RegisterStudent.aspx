...
<head runat="server">
    ...
    <title>Enrol Student - Head of Programme</title>
    ...
    <style>
        ...
        .student-icon {
            width: 80px; height: 80px; background: linear-gradient(135deg, #1abc9c, #16a085);
    ...
    <form id="form1" runat="server">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-3">
                ...
                <div class="nav-item">
                    <a href="RegisterStudent.aspx" class="nav-link active"><i class="fas fa-user-graduate"></i><span>Enrol Student</span></a>
                </div>
                <div class="nav-item">
        ...
        <div class="main-content">
            ...
            <div class="topbar">
                <h2><i class="fas fa-user-graduate me-2" style="color:#1abc9c;"></i>Enrol New Student</h2>
                    ...
                    <div class="col-lg-8">
                        <div class="content-card">
                            <div class="card-header">
                                <h5><i class="fas fa-list me-2 text-primary"></i>Enrolled Students</h5>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <asp:GridView ID="gvStudents" runat="server"
                                        ...
                                        EmptyDataText="No students enrolled yet.">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="studentID" HeaderText="ID" ItemStyle-Width="80px" />
                    ...
                    <div class="col-lg-4">
                        <div class="content-card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-4">Enrol New Student</h5>
                                ...
                                <div class="text-start">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" TextMode="Email" placeholder="student@college.edu" />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <asp:CompareValidator ID="cvPassword" runat="server" ControlToValidate="txtConfirmPassword"
                                            ControlToCompare="txtPassword" ValidationGroup="stud" CssClass="text-danger small" Display="Dynamic"
                                    ...
                                    <div class="d-grid gap-2">
                                        <asp:Button ID="btnEnrol" runat="server" Text="Enrol Student" 
                                            CssClass="btn btn-save" ValidationGroup="stud" OnClick="btnEnrol_Click" />
